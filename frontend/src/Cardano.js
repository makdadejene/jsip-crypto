...
export const background = '#252627';
export const background2 = '#cfd2cd';
...
const Cardano = withTooltip(
    ({
        ...
        useEffect(() => {
            fetch("http://ec2-44-196-240-247.compute-1.amazonaws.com:8181/api/cardano")
                .then((response) => {
...
export const cardanoLoader = async ({ params }) => {
    return { cardanoWindow: params.window }
}
