...
export const background = '#081c15';
export const background2 = '#97a97c';
...
const Bnb = withTooltip(
    ({
        ...
        useEffect(() => {
            fetch("http://ec2-44-196-240-247.compute-1.amazonaws.com:8181/api/bnb")
                .then((response) => {
...
export const bnbLoader = async ({ params }) => {
